...
class OptFunc(Protocol):
    ...
    def hessian(self, x: np.ndarray) -> np.ndarray:
        """Hessian of the function, i.e. matrix of second derivatives."""
        ...
...
class AddFunctions:
    ...
    The values, gradients and hessians will be added together.

    Parameters
    ----------
    functions
        A list of functions to optimise.
    """
    ...
    def value(self, x: np.ndarray) -> float:
        """Sum of the individual function values."""
        return sum(f.value(x) for f in self.functions)

    def gradient(self, x: np.ndarray) -> np.ndarray:
        """Sum of the individual function gradients."""
    ...
    def hessian(self, x: np.ndarray) -> np.ndarray:
        """Sum of the individual function hessians."""
