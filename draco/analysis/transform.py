...
class LanczosRegridder(task.SingleTask):
    ...
    snr_cov : float
        Numerical regulariser used in kernel inversion. This is a deprecated
        property which has been replace with `epsilon`, and will not do anything.
    """
    ...
    snr_cov = config.Property(proptype=float, default=None, deprecated=True)
