...
class Regridder(task.SingleTask):
    ...
    lanczos_width : int
        ...
        has been replaced with `kernel_width`, but will continue to work for
        the time being.
    """
    ...
    lanczos_width = config.Property(
        proptype=int, default=None, key="lanczos_width", deprecated=True
    )
    ...
    def setup(self, observer):
        ...
        if self.lanczos_width is not None:
            self.kernel_width = self.lanczos_width
