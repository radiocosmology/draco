...
class MockCatalogGenerator(task.SingleTask, task.random.RandomTask):
...
class AddGaussianZErrorsToCatalog(task.SingleTask, task.random.RandomTask):
...
class AddEBOSSZErrorsToCatalog(task.SingleTask, task.random.RandomTask):
