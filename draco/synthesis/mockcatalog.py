...
class SelectionFunctionEstimator(SingleTask):
...
class ResizeSelectionFunctionMap(SingleTask):
...
class PdfGeneratorBase(SingleTask):
...
class MockCatalogGenerator(SingleTask, RandomTask):
...
class AddGaussianZErrorsToCatalog(SingleTask, RandomTask):
...
class AddEBOSSZErrorsToCatalog(SingleTask, RandomTask):
...
class MapPixelLocationGenerator(SingleTask):
